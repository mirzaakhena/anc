(function() {
    ...
    angular
        .module('web')
        .controller('AccountPayableInputController', AccountPayableInputController);

    /** @ngInject */
    function AccountPayableInputController($uibModal, SERVER_PATH, $http, account, $uibModalInstance, $scope, AccountPayableService) {

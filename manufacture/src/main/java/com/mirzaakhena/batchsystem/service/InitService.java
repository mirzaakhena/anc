...
public class InitService {
	...
	private void daftarkanAkunAkun() throws Exception {
		accountService.addByFile("accounts.txt");
	}

	private void linkingAccount() throws Exception {
	...
	private void inputRawMaterial() throws Exception {
	...
	private void inputFinishedGoods() throws Exception {
		{
	...
	private void inputCustomerService() throws Exception {
	...
	private void inputSupplierService() throws Exception {
	...
	private void masukkanSaldoAwal() throws Exception {
		{
	...
	private void beliRawMaterialPertama() throws Exception {
	...
	private void beliRawMaterialKedua() throws Exception {
	...
	private void startProduksi() throws Exception {
	...
	private void finishProduksi() throws Exception {
	...
	private void beliRawMaterialSecaraManual() throws Exception {
